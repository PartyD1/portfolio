...
- **Card** (`.timeline__card`): `{colors.glass}`, 1px edge, 22px, `padding: 26px 28px 28px`, a flex column with a 6px gap: role (`.timeline__role`, 1.0625rem / 600), organisation (`.timeline__org`, 1rem, `--ink-2`), ownership (1rem / 1.55, `--ink-2`, 62ch, 8px above), then the project chip 18px below.
